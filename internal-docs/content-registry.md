...
> Timestamp ranges are placeholders based on the "60 minute" target length. They will be locked once the final cut and the source course outline (Udemy link in user brief) are reconciled.
