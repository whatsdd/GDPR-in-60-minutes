...
Last updated: 2026-05-23 (asset pipeline shipped; three Playbook chapters with Excel templates added)
...
| # | Title | Markdown file | Excel template | Status |
|---|---|---|---|---|
| 1 | Handle a DSAR in 30 days | `docs/playbooks/01-dsar.md` | `docs/public/checklists/dsar-log.xlsx` | 🟡 |
| 2 | Respond to a breach in 72 hours | `docs/playbooks/02-breach.md` | `docs/public/checklists/breach-triage.xlsx` | 🟡 |
| 3 | Vet a SaaS vendor in 30 minutes | `docs/playbooks/03-vendor-vet.md` | `docs/public/checklists/vendor-register.xlsx` | 🟡 |

Excel templates are generated by `tools/generate-checklists.py` (run `python tools/generate-checklists.py` after editing the script). Templates are committed as binaries.
